\documentclass[a4paper,11pt,ceqn,dvipsnames,twoside,openright]{memoir}  	% Openright aabner kapitler paa hoejresider (openany begge)
...
% ¤¤ Marginer ¤¤ %
\setlrmarginsandblock{3.5cm}{3.0cm}{*}		% \setlrmarginsandblock{Indbinding}{Kant}{Ratio}
...
\makeevenhead{AAU}{Gr938}{}{\leftmark}					    % Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
...
\makefootrule{AAU}{\textwidth}{0.5pt}{1mm}					% Adds a line below the footer's content
