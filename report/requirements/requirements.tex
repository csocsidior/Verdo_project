...
\emph{This chapter presents the mathematical description of hydraulic components in water distribution networks. Thereby, the physical measures of hydraulic systems are introduced. The similarities to electronic networks are shown by explaining the relevant properties of graph theory. The model of a single and multi-inlet network, presented in \cite{oneinput_paper}, is first introduced, then the model description is extended such that it is capable of handling multiple Water Tanks. In the end of the chapter, different models are compared and a summary of the extended system model is given.}
