...
\newline
\hspace*{6mm} $F^T \in \: \mathbb{R}^{(1 \times c)}$ \\
\hspace*{6mm} $G^T \in \: \mathbb{R}^{(c\!-\!l\! \times \!c)}$
\end{minipage}
\begin{minipage}[t]{0.68\textwidth}
\vspace*{2mm}
