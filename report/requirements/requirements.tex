...
\textcolor{White}{te}$\unit{m}$
\end{minipage}
The derivation of \eqref{resistance_coefficient} is explained more in detail in appref \cite{chen2016sustainable}. Furthermore, in the following sections it is assumed that each $f_i$ has a structure shown in \eqref{deltap_friction}.
