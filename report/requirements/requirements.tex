...
In the further thesis, a distinction is made between inlet and non-inlet nodes. It is assumed that the demand at non-inlet nodes fulfil the constraint in \eqref{non_inlet_constraint}.
