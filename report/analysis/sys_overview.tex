...
\section{The Randers water supply network (in progress)}
...
\begin{itemize}
  ...
  \item Are PRVs and FCVs really placed at the pumping stations in reality, or just for simulation purposes
  \item Which tanks 
...
\centering
\includegraphics[width=0.35\textwidth]{report/pictures/missingfigure}
\caption{Elevated reservoirs in the Randers WSS (encircled in blue).}
\label{fig:tanks_EPANET}
\end{figure}