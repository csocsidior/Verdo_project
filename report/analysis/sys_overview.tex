\emph{This chapter gives a general overview of hydraulic systems and an introduction to the WSS in Randers. The typical topologies and components of drinking water supply networks are discussed. The different distribution zones, pumping stations, waterworks and WTs are introduced and their operation purposes are explained in the Randers WSS.}
