...
Although the network consists of many different distribution zones, the distribution in the city can be split into four main areas regarding the different geographical properties of the different parts. Furthermore, Randers can be split into two regions, Randers North and Randers South. This is due to the fact that Randers fjord divides the city into a northern and a southern part\cite{verdo}. 
