...
\emph{In this part of the appendix, the different assumptions and simplifications, which were applied in the project, are collected. In order to ease the reading, each assumption has a section reference, which points back to the place where it was used in the report.}
