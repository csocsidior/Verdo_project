...
comma2point_overwrite('example_v1.rpt')
fid = fopen('example_v1.rpt','r');
str = fgetl(fid);
...
xlim([0 149])
%title('PU1 flow','latex')
xlabel('Time [h]','interpreter','latex');
ylabel('Pressure  [m]','interpreter','latex')

%dk1 dk2 sigma pWT pk1 pk2 
sigma_base = 25;
dk_1_v1 = link_flows(:,1);
dk_2_v1 = link_flows(:,2);
sigma_v0 = nodal_demands(:,1)/5;
sigma_v1 = sigma_v0*sigma_base;
pk_2_v1 = nodal_pressures(:,1);
